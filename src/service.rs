...
native_executor_instance!(
	pub Executor,
	offchain_cb_runtime::api::dispatch,
	offchain_cb_runtime::native_version
);
...
macro_rules! new_full_start {
	($config:expr) => {{
		...
		let builder = substrate_service::ServiceBuilder::new_full::<
			offchain_cb_runtime::opaque::Block, offchain_cb_runtime::RuntimeApi, crate::service::Executor
		>($config)?
			...
			.with_import_queue(|_config, client, mut select_chain, transaction_pool| {
				...
				let (block_import, link_half) =
					grandpa::block_import::<_, _, _, offchain_cb_runtime::RuntimeApi, _, _>(
